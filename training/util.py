...
def register_datasets(root_dir, class_list_file):
    ...
    for d in ['train', 'val']:
        ...
        DatasetCatalog.register(d, lambda d=d: get_dicts(os.path.join("C:/Users/verta/Downloads/Tubes Viskom/training/data/data", d, 'imgs'),
                                                        os.path.join("C:/Users/verta/Downloads/Tubes Viskom/training/data/data", d, 'anns')))
